...
CREATE TABLE IF NOT EXISTS events (
    ...
    detector_people_state text,
    detector_queue_max bigint,
    detector_queue_min bigint,
    ...
    detector_lpr_direction integer,
    detector_lpr_country text,
    detector_lpr_plate text,
    detector_lpr_best_datetime timestamp without time zone,
    detector_lpr_best_utc timestamp without time zone,
    detector_lpr_begin_datetime timestamp without time zone,
    detector_lpr_begin_utc timestamp without time zone,
    detector_lpr_end_datetime timestamp without time zone,
    detector_lpr_end_utc timestamp without time zone,
    "detector_listedItem_matched_event_time_utc" timestamp without time zone,
    "detector_listedItem_matched_event_time_datetime" timestamp without time zone,
    "detector_listedItem_matched_event_id" uuid,
    "detector_listedItem_list_id" uuid,
    "detector_listedItem_item_id" uuid,
    "detector_listedFace_score" double precision,
    detector_temperature_time_begin timestamp without time zone,
    detector_temperature_time_begin_utc timestamp without time zone,
    detector_temperature_value double precision,
    detector_temperature_unit text,
    camera_display_id text,
    camera_group_id text,
    camera_group_name text,
    utc_offset integer,
